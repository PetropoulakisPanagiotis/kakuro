...
Kakuro.py can solve kakuro puzzles with FC and MAC algorithms. Puzzles are hard-coded, but the user can set its own puzzles. In the end of the computations winner algorithm is printed. <br /> <br />
